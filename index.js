...
var ASM_CONSTS = {
  112678: () => { if (document.fullscreenElement) return 1; },  
 112724: () => { return Module.canvas.width; },  
 112756: () => { return parseInt(Module.canvas.style.width); },  
 112804: () => { document.exitFullscreen(); },  
 112831: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 112903: () => { if (document.fullscreenElement) return 1; },  
 112949: () => { return Module.canvas.width; },  
 112981: () => { return screen.width; },  
 113006: () => { document.exitFullscreen(); },  
 113033: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 113227: () => { return window.innerWidth; },  
 113253: () => { return window.innerHeight; },  
 113280: () => { if (document.fullscreenElement) return 1; },  
 113326: () => { return Module.canvas.width; },  
 113358: () => { return parseInt(Module.canvas.style.width); },  
 113406: () => { if (document.fullscreenElement) return 1; },  
 113452: () => { return Module.canvas.width; },  
 113484: () => { return screen.width; },  
 113509: () => { return window.innerWidth; },  
 113535: () => { return window.innerHeight; },  
 113562: () => { if (document.fullscreenElement) return 1; },  
 113608: () => { return Module.canvas.width; },  
 113640: () => { return screen.width; },  
 113665: () => { document.exitFullscreen(); },  
 113692: () => { if (document.fullscreenElement) return 1; },  
 113738: () => { return Module.canvas.width; },  
 113770: () => { return parseInt(Module.canvas.style.width); },  
 113818: () => { document.exitFullscreen(); },  
 113845: ($0) => { Module.canvas.style.opacity = $0; },  
 113883: () => { return screen.width; },  
 113908: () => { return screen.height; },  
 113934: () => { return window.screenX; },  
 113961: () => { return window.screenY; },  
 113988: () => { return window.devicePixelRatio; },  
 114024: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114077: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 114128: () => { Module.canvas.style.cursor = 'none'; },  
 114165: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114421: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 114472: () => { if (document.pointerLockElement) return 1; },  
 114519: () => { if (document.fullscreenElement) return 1; },  
 114565: () => { return window.innerWidth; },  
 114591: () => { return window.innerHeight; }
};
