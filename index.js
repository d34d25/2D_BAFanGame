...
var ASM_CONSTS = {
  112902: () => { if (document.fullscreenElement) return 1; },  
 112948: () => { return Module.canvas.width; },  
 112980: () => { return parseInt(Module.canvas.style.width); },  
 113028: () => { document.exitFullscreen(); },  
 113055: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 113127: () => { if (document.fullscreenElement) return 1; },  
 113173: () => { return Module.canvas.width; },  
 113205: () => { return screen.width; },  
 113230: () => { document.exitFullscreen(); },  
 113257: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 113451: () => { return window.innerWidth; },  
 113477: () => { return window.innerHeight; },  
 113504: () => { if (document.fullscreenElement) return 1; },  
 113550: () => { return Module.canvas.width; },  
 113582: () => { return parseInt(Module.canvas.style.width); },  
 113630: () => { if (document.fullscreenElement) return 1; },  
 113676: () => { return Module.canvas.width; },  
 113708: () => { return screen.width; },  
 113733: () => { return window.innerWidth; },  
 113759: () => { return window.innerHeight; },  
 113786: () => { if (document.fullscreenElement) return 1; },  
 113832: () => { return Module.canvas.width; },  
 113864: () => { return screen.width; },  
 113889: () => { document.exitFullscreen(); },  
 113916: () => { if (document.fullscreenElement) return 1; },  
 113962: () => { return Module.canvas.width; },  
 113994: () => { return parseInt(Module.canvas.style.width); },  
 114042: () => { document.exitFullscreen(); },  
 114069: ($0) => { Module.canvas.style.opacity = $0; },  
 114107: () => { return screen.width; },  
 114132: () => { return screen.height; },  
 114158: () => { return window.screenX; },  
 114185: () => { return window.screenY; },  
 114212: () => { return window.devicePixelRatio; },  
 114248: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114301: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 114352: () => { Module.canvas.style.cursor = 'none'; },  
 114389: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114645: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 114696: () => { if (document.pointerLockElement) return 1; },  
 114743: () => { if (document.fullscreenElement) return 1; },  
 114789: () => { return window.innerWidth; },  
 114815: () => { return window.innerHeight; }
};
