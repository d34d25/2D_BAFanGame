...
var ASM_CONSTS = {
  112822: () => { if (document.fullscreenElement) return 1; },  
 112868: () => { return Module.canvas.width; },  
 112900: () => { return parseInt(Module.canvas.style.width); },  
 112948: () => { document.exitFullscreen(); },  
 112975: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 113047: () => { if (document.fullscreenElement) return 1; },  
 113093: () => { return Module.canvas.width; },  
 113125: () => { return screen.width; },  
 113150: () => { document.exitFullscreen(); },  
 113177: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 113371: () => { return window.innerWidth; },  
 113397: () => { return window.innerHeight; },  
 113424: () => { if (document.fullscreenElement) return 1; },  
 113470: () => { return Module.canvas.width; },  
 113502: () => { return parseInt(Module.canvas.style.width); },  
 113550: () => { if (document.fullscreenElement) return 1; },  
 113596: () => { return Module.canvas.width; },  
 113628: () => { return screen.width; },  
 113653: () => { return window.innerWidth; },  
 113679: () => { return window.innerHeight; },  
 113706: () => { if (document.fullscreenElement) return 1; },  
 113752: () => { return Module.canvas.width; },  
 113784: () => { return screen.width; },  
 113809: () => { document.exitFullscreen(); },  
 113836: () => { if (document.fullscreenElement) return 1; },  
 113882: () => { return Module.canvas.width; },  
 113914: () => { return parseInt(Module.canvas.style.width); },  
 113962: () => { document.exitFullscreen(); },  
 113989: ($0) => { Module.canvas.style.opacity = $0; },  
 114027: () => { return screen.width; },  
 114052: () => { return screen.height; },  
 114078: () => { return window.screenX; },  
 114105: () => { return window.screenY; },  
 114132: () => { return window.devicePixelRatio; },  
 114168: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114221: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 114272: () => { Module.canvas.style.cursor = 'none'; },  
 114309: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 114565: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 114616: () => { if (document.pointerLockElement) return 1; },  
 114663: () => { if (document.fullscreenElement) return 1; },  
 114709: () => { return window.innerWidth; },  
 114735: () => { return window.innerHeight; }
};
