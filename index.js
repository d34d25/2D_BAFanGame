...
var ASM_CONSTS = {
 ...
 113396: () => { return Module.canvas.width; },  
 113428: () => { return parseInt(Module.canvas.style.width); },  
 113476: () => { document.exitFullscreen(); },  
 113503: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 113575: () => { if (document.fullscreenElement) return 1; },  
 113621: () => { return Module.canvas.width; },  
 113653: () => { return screen.width; },  
 113678: () => { document.exitFullscreen(); },  
 113705: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 113899: () => { return window.innerWidth; },  
 113925: () => { return window.innerHeight; },  
 113952: () => { if (document.fullscreenElement) return 1; },  
 113998: () => { return Module.canvas.width; },  
 114030: () => { return parseInt(Module.canvas.style.width); },  
 114078: () => { if (document.fullscreenElement) return 1; },  
 114124: () => { return Module.canvas.width; },  
 114156: () => { return screen.width; },  
 114181: () => { return window.innerWidth; },  
 114207: () => { return window.innerHeight; },  
 114234: () => { if (document.fullscreenElement) return 1; },  
 114280: () => { return Module.canvas.width; },  
 114312: () => { return screen.width; },  
 114337: () => { document.exitFullscreen(); },  
 114364: () => { if (document.fullscreenElement) return 1; },  
 114410: () => { return Module.canvas.width; },  
 114442: () => { return parseInt(Module.canvas.style.width); },  
 114490: () => { document.exitFullscreen(); },  
 114517: ($0) => { Module.canvas.style.opacity = $0; },  
 114555: () => { return screen.width; },  
 114580: () => { return screen.height; },  
 114606: () => { return window.screenX; },  
 114633: () => { return window.screenY; },  
 114660: () => { return window.devicePixelRatio; },  
 114696: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 114749: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 114800: () => { Module.canvas.style.cursor = 'none'; },  
 114837: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 115093: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 115144: () => { if (document.pointerLockElement) return 1; },  
 115191: () => { if (document.fullscreenElement) return 1; },  
 115237: () => { return window.innerWidth; },  
 115263: () => { return window.innerHeight; }
};
